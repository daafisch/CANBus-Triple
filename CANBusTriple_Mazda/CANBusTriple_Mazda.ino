...
CANBus busses[3] = { 
  CANBus1, CANBus2, CANBus3 };
CANBus SerialCommand::busses[3] = { 
  CANBus1, CANBus2, CANBus3 }; // Maybe do this better
...
void setup(){
  ...
  //Service call setup
  timers.setInterval(200, MazdaLED::boostServiceCall);
  delay(5);
  timers.setInterval(200, MazdaLED::afrServiceCall);
  delay(5);
  timers.setInterval(200, MazdaLED::fpServiceCall);
  delay(5);
  timers.setInterval(500, MazdaLED::batServiceCall);
  delay(5);
  timers.setInterval(100, MazdaLED::knockServiceCall);
  delay(5);
  //Button press timer
  //timers.setInterval(100, processButtons);
}
...
void sendTestFrame(){
  ...
  Message msg;
  msg.busId = 3;
  msg.frame_id = 0x4C4;     // 02 01 0D 00 00 00 00 00
  msg.frame_data[0] = 0xAC;
  msg.frame_data[1] = 0x02;
  msg.frame_data[2] = 0x54;
  msg.frame_data[3] = 0x65;
  msg.frame_data[4] = 0x53;
  msg.frame_data[5] = 0x74;
  msg.frame_data[6] = MazdaLED::gaugePage;
